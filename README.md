...
%%(math outline) Flesch-Kincaid Grade Level = {0.39\times (\frac{общее количество предложений}общее количество слов)+ 11.8\times (\frac{общее количество слов}общее количество слогов )−15.59} %%
...
Рассчитывает [показатели](https://uploads.philology.by/golovin-b.n_.-jazyk-i-statistika-1971_.pdf), которые используются в лингвистическом анализе текста для количественной оценки его содержания, структуры и стиля. Эти коээфициенты применяются для характеристики текста с точки зрения его смысловой наполненности, динамики, связности и других параметров, что помогает глубже понять его структуру и качество.
